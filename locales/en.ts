...
const en = {
  ...
  readNext: 'Read next',
  readNextSeries: 'Next in the series',
  ...
  archiveMeta: 'Every post on {site}, by year.',
  archiveYears: 'Years',
  archiveEmpty: 'Nothing in the archive yet.',
  ...
  clipHeading: 'Keep in the notebook',
  clipTitleLabel: 'Title',
  clipNoteLabel: 'Your note',
  clipPrivate: 'Private',
  clipPublic: 'Public',
  clipSave: 'Keep',
  clipSavedHeading: 'Kept.',
  clipSavedView: 'Open the note',
  clipAgain: 'Keep another',
  clipToolHeading: 'Keep from anywhere',
  clipToolHint: 'Drag this to your bookmarks bar. On any page, select a passage and click it: it lands here, with where it came from.',
  clipToolLabel: 'Keep in {site}',
  readerPenSend: 'Send to my notebook',
  readerPenNotebookAsk: 'Where is your Quire Ink? Its address:',
  readerPenNotebookGo: 'Send',
  ...
  quoteCopied: 'Copied',
  readerPenHighlight: 'Highlight',
  readerPenUnderline: 'Underline',
  readerPenRing: 'Ring',
  readerPenNote: 'Note',
  readerPenDelete: 'Remove mark',
  readerPenNoteHint: 'Your note, kept in this browser',
  readerPenKeptHere: 'Kept in this browser only.',
  readerPenKeep: 'Keep on every device',
  readerPenKeepGoogle: 'Sign in with Google',
  readerPenKeepCode: 'Get a code',
  readerPenKeepHave: 'Have a code? Paste it:',
  readerPenKeepUse: 'Use',
  readerPenKept: 'Kept on every device.',
  readerPenKeepHint: 'Write this code down. It is the only key to your marks, and it works on any device.',
  readerPenForgetHere: 'Forget on this device',
  readerPenForgetAll: 'Forget everywhere',
  readerPenKeepBad: 'That code is not known here.',
  readerPenShowCode: 'Show code',
