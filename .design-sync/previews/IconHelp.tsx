...
export function Default() {
  return (
    <div className="flex items-center gap-3 p-4 text-neutral-700">
      <IconHelp />
      <span className="text-sm">IconHelp — the Help rail entry</span>
    </div>
  )
}
...
export function InheritsColour() {
  return (
    <div className="flex items-center gap-6 p-4">
      <span className="text-neutral-900"><IconHelp /></span>
      <span className="text-neutral-500"><IconHelp /></span>
      <span className="text-neutral-300"><IconHelp /></span>
    </div>
  )
}
