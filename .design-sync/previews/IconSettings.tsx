import { IconSettings } from 'quireink'
...
export function Default() {
  return (
    <div className="flex items-center gap-3 p-4 text-neutral-700">
      <IconSettings />
      <span className="text-sm">IconSettings — the Settings rail entry</span>
    </div>
  )
}
...
export function InheritsColour() {
  return (
    <div className="flex items-center gap-6 p-4">
      <span className="text-neutral-900"><IconSettings /></span>
      <span className="text-neutral-500"><IconSettings /></span>
      <span className="text-neutral-300"><IconSettings /></span>
    </div>
  )
}
