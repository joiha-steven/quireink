import { IconComment } from 'quireink'
...
export function Default() {
  return (
    <div className="flex items-center gap-3 p-4 text-neutral-700">
      <IconComment />
      <span className="text-sm">IconComment — the Comments rail entry</span>
    </div>
  )
}
...
export function InheritsColour() {
  return (
    <div className="flex items-center gap-6 p-4">
      <span className="text-neutral-900"><IconComment /></span>
      <span className="text-neutral-500"><IconComment /></span>
      <span className="text-neutral-300"><IconComment /></span>
    </div>
  )
}
