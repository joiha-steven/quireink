import { IconMedia } from 'quireink'
...
export function Default() {
  return (
    <div className="flex items-center gap-3 p-4 text-neutral-700">
      <IconMedia />
      <span className="text-sm">IconMedia — the Media rail entry</span>
    </div>
  )
}
...
export function InheritsColour() {
  return (
    <div className="flex items-center gap-6 p-4">
      <span className="text-neutral-900"><IconMedia /></span>
      <span className="text-neutral-500"><IconMedia /></span>
      <span className="text-neutral-300"><IconMedia /></span>
    </div>
  )
}
