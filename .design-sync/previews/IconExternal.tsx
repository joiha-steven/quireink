import { IconExternal } from 'quireink'
...
export function Default() {
  return (
    <div className="flex items-center gap-3 p-4 text-neutral-700">
      <IconExternal />
      <span className="text-sm">IconExternal — the View site rail entry</span>
    </div>
  )
}
...
export function InheritsColour() {
  return (
    <div className="flex items-center gap-6 p-4">
      <span className="text-neutral-900"><IconExternal /></span>
      <span className="text-neutral-500"><IconExternal /></span>
      <span className="text-neutral-300"><IconExternal /></span>
    </div>
  )
}
