import { IconContent } from 'quireink'
...
export function Default() {
  return (
    <div className="flex items-center gap-3 p-4 text-neutral-700">
      <IconContent />
      <span className="text-sm">IconContent — the Content rail entry</span>
    </div>
  )
}
...
export function InheritsColour() {
  return (
    <div className="flex items-center gap-6 p-4">
      <span className="text-neutral-900"><IconContent /></span>
      <span className="text-neutral-500"><IconContent /></span>
      <span className="text-neutral-300"><IconContent /></span>
    </div>
  )
}
