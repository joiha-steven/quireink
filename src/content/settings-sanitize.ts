...
export function sanitizeFeatures(input: unknown, fallback: FeatureSettings): FeatureSettings {
  ...
  return {
    ...
    transferStats: bool(o.transferStats, fallback.transferStats),
    sidebar: bool(o.sidebar, fallback.sidebar),
    sidebarSeries: bool(o.sidebarSeries, fallback.sidebarSeries),
    sidebarCategories: bool(o.sidebarCategories, fallback.sidebarCategories),
    sidebarTags: bool(o.sidebarTags, fallback.sidebarTags),
    sidebarArchive: bool(o.sidebarArchive, fallback.sidebarArchive),
...
export function sanitizeFeatured(v: unknown, fallback: string[]): string[] {
  ...
  const out: string[] = []
  for (const s of withHolesFilled(v, fallback)) {
