...
form.search input{min-width:0;flex:1;padding:.5rem .75rem;border:1px solid var(--c-field-edge);
...
form.search button{padding:.5rem 1rem;border:1px solid var(--c-field-edge);border-radius:var(--radius,.5rem);
