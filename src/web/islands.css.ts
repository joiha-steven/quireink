...
.pen-pop textarea{display:block;width:100%;min-height:3.2em;padding:.4rem .5rem;
  border:1px solid var(--c-field-edge);border-radius:var(--radius,.5rem);background:var(--c-bg);
...
.pen-ask input{flex:1;min-width:0;padding:.3rem .5rem;border:1px solid var(--c-field-edge);
...
.pen-keep input{width:100%;margin:.35rem 0;padding:.3rem .5rem;border:1px solid var(--c-field-edge);
  border-radius:var(--radius,.5rem);background:var(--c-bg);color:inherit;font:inherit}
