...
export function ActivityLog({ entries, enabled }: { entries: ActivityEntry[]; enabled: boolean }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {!enabled && (
        <p className="border border-neutral-300 bg-neutral-100 px-4 py-3 text-sm leading-6 text-neutral-800 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-200">
          {t.logDisabled}
        </p>
      )}
