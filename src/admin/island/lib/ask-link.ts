...
//
// The dialog itself is still React's, mounted beside the page by `App.tsx`, so the ask goes out
// as an event: the bridge ADR 0054 established. `quire:confirm` carries an optional field and
// answers with what was typed, which is what made `window.prompt` removable at all.
//
