...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ListingFeatureFields.tsx
  var ListingFeatureFields_exports = {};
  __export(ListingFeatureFields_exports, {
    Basic: () => Basic,
    Minimal: () => Minimal
  });
  init_define_import_meta_env();
  ...
  function Basic() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ListingFeatureFields, { features: SETTINGS.features, onChange: () => {
    } });
  }
  function Minimal() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.ListingFeatureFields,
      {
  ...
  return __toCommonJS(ListingFeatureFields_exports);
})();
