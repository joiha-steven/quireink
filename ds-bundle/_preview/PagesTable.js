...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/PagesTable.tsx
  var PagesTable_exports = {};
  __export(PagesTable_exports, {
    Basic: () => Basic,
    Empty: () => Empty
  });
  init_define_import_meta_env();
  ...
  function Basic() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.PagesTable, { initialPages: PAGES, views: VIEWS });
  }
  function Empty() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.PagesTable, { initialPages: [], views: {} });
  }
  return __toCommonJS(PagesTable_exports);
})();
