...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ActivityLog.tsx
  ...
  function WithEntries() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ActivityLog, { entries: ACTIVITY, enabled: true });
  }
  function Empty() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ActivityLog, { entries: [], enabled: true });
  }
  function Disabled() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ActivityLog, { entries: [], enabled: false });
  }
  return __toCommonJS(ActivityLog_exports);
})();
