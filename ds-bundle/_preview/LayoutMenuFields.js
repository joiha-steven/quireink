...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/LayoutMenuFields.tsx
  var LayoutMenuFields_exports = {};
  __export(LayoutMenuFields_exports, {
    EmptyMenu: () => EmptyMenu,
    WithMenu: () => WithMenu
  });
  init_define_import_meta_env();
  ...
  function EmptyMenu() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.LayoutMenuFields, { s: SETTINGS, update: () => {
    }, posts: POST_REFS, pages: PAGE_REFS });
  }
  function WithMenu() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.LayoutMenuFields,
      {
        s: {
          ...SETTINGS,
          menu: [
  ...
  return __toCommonJS(LayoutMenuFields_exports);
})();
