...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/FontUpload.tsx
  var FontUpload_exports = {};
  __export(FontUpload_exports, {
    NoCustomFont: () => NoCustomFont,
    WithUploadedFace: () => WithUploadedFace
  });
  init_define_import_meta_env();
  ...
  function NoCustomFont() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.FontUpload, { value: SETTINGS.customFont, onChange: () => {
    } });
  }
  function WithUploadedFace() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.FontUpload,
      {
        value: {
          family: "Cardo",
          faces: [
  ...
  return __toCommonJS(FontUpload_exports);
})();
