...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/CommentsTable.tsx
  var CommentsTable_exports = {};
  __export(CommentsTable_exports, {
    Basic: () => Basic,
    Empty: () => Empty
  });
  init_define_import_meta_env();
  ...
  function Basic() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.CommentsTable, { initial: COMMENTS });
  }
  function Empty() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.CommentsTable, { initial: [] });
  }
  return __toCommonJS(CommentsTable_exports);
})();
