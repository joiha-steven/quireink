...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/BrandFields.tsx
  var BrandFields_exports = {};
  __export(BrandFields_exports, {
    LogoOff: () => LogoOff,
    LogoOn: () => LogoOn
  });
  init_define_import_meta_env();
  ...
  function LogoOff() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.BrandFields, { s: { ...SETTINGS, showLogo: false }, update: () => {
    } });
  }
  function LogoOn() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.BrandFields, { s: { ...SETTINGS, showLogo: true }, update: () => {
    } });
  }
  return __toCommonJS(BrandFields_exports);
})();
