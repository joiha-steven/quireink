...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/CommentIntegrations.tsx
  var CommentIntegrations_exports = {};
  __export(CommentIntegrations_exports, {
    BothOff: () => BothOff,
  ...
  var ON = { ...SETTINGS.comments, enabled: true, turnstile: true, googleAuth: true };
  function KeysPresent() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.CommentIntegrations,
      {
        comments: ON,
  ...
  function BothOff() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.CommentIntegrations, { comments: SETTINGS.comments, env: COMMENT_ENV, onChange: () => {
    } });
  }
  return __toCommonJS(CommentIntegrations_exports);
})();
