...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/SiteFields.tsx
  var SiteFields_exports = {};
  __export(SiteFields_exports, {
    Empty: () => Empty,
    Filled: () => Filled
  });
  init_define_import_meta_env();
  ...
  function Empty() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.SiteFields, { s: SETTINGS, update: () => {
    } });
  }
  function Filled() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.SiteFields,
      {
        s: {
          ...SETTINGS,
          title: "Quire Ink",
  ...
  return __toCommonJS(SiteFields_exports);
})();
