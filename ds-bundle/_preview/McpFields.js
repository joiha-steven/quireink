...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/McpFields.tsx
  var McpFields_exports = {};
  __export(McpFields_exports, {
    Basic: () => Basic,
    Enabled: () => Enabled
  });
  init_define_import_meta_env();
  ...
  function Basic() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.McpFields, { mcp: SETTINGS.mcp, siteUrl: "https://quireink.com", onChange: () => {
    } });
  }
  function Enabled() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.McpFields,
      {
  ...
  return __toCommonJS(McpFields_exports);
})();
