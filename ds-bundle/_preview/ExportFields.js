...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ExportFields.tsx
  var ExportFields_exports = {};
  __export(ExportFields_exports, {
    Basic: () => Basic,
  ...
  function Basic() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ExportFields, { backups: SETTINGS.backups, onChange: () => {
    } });
  }
  function ScheduledOn() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ExportFields, { backups: { ...SETTINGS.backups, enabled: true }, onChange: () => {
    } });
  }
  return __toCommonJS(ExportFields_exports);
})();
