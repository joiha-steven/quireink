...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/NewsletterSend.tsx
  var NewsletterSend_exports = {};
  __export(NewsletterSend_exports, {
    Basic: () => Basic,
  ...
  function Basic() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.NewsletterSend, { posts: SENDABLE });
  }
  function NothingToSend() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.NewsletterSend, { posts: [] });
  }
  return __toCommonJS(NewsletterSend_exports);
})();
