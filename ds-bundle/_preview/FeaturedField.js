...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/FeaturedField.tsx
  var FeaturedField_exports = {};
  __export(FeaturedField_exports, {
    NonePicked: () => NonePicked,
    TwoPicked: () => TwoPicked
  });
  init_define_import_meta_env();
  ...
  function NonePicked() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.FeaturedField, { posts: POST_REFS, value: [], onChange: () => {
    } });
  }
  function TwoPicked() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ds_exports.FeaturedField,
      {
        posts: POST_REFS,
  ...
  return __toCommonJS(FeaturedField_exports);
})();
