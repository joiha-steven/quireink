...
Typecheck, the ten static guards (`filesize` · `css` · `nul` · `routes` · `type` ·
`admin-kit` · `bundle` · `contract` · `docs` · `deps`) and `bun test`. About 2 minutes. A change under `src/md`, `src/render` or
