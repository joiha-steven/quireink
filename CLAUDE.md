...
Typecheck, the eleven static guards (`filesize` · `css` · `nul` · `routes` · `type` ·
`admin-kit` · `bundle` · `contract` · `docs` · `deps` · `admin-css`) and `bun test`. About 2 minutes. A change under `src/md`, `src/render` or
