...
**2.2.14** lo cho cái máy bên dưới. Nó chạy được trong 192 MB thay vì 256 MB, bản sao lưu có thể rời máy ở dạng đã niêm phong, và mỗi lần nâng cấp đều chép cơ sở dữ liệu ra trước khi đụng vào. Nó đang chạy trang demo ở trên lẫn blog của chính tác giả tại [manhhung.me](https://manhhung.me). [Nhật ký thay đổi](../CHANGELOG.md) ghi đủ, kèm số đo từng mục.

- **Chạy vừa một máy nhỏ.** Mỗi cỡ ảnh được nén trong một tiến trình con riêng, nên libvips không còn đẩy máy chủ lên 136 MB rồi giữ luôn ở đó; ở 192 MB một lượt nén có thể bị dừng rồi làm lại, còn blog vẫn phục vụ bình thường. Máy chủ chạy `bun --smol`, đưa một container 128 MB từ 121,5 MB và không bao giờ khởi động xong xuống 55 MB và 379 ms, và bộ đệm trang giờ có ngân sách, mặc định 8 MB.
- **Bản sao lưu rời máy ở dạng niêm phong.** Nó chứa mọi mật khẩu và khoá mà blog giữ, và giờ máy chủ có thể niêm phong nó bằng hai chìa mà chính nó không mở được: một danh tính chỉ hiện một lần và một cụm mật khẩu. **Tắt sẵn lúc cài và khi nâng cấp** (Cài đặt, Máy chủ và kết nối, Sao lưu). Mất cả hai chìa thì không ai mở được.
- **Nâng cấp là chép cơ sở dữ liệu ra trước khi đổi nó**, vào `data/backups/`, và không chạy migration nếu không chép được. Một migration để lại tệp gần như trống sẽ được nén lại một lần: cơ sở dữ liệu 618 MB chỉ có 8 MB chữ viết đã về lại 8,9 MB.
- **Bốn lối giao diện mỗi cái ra một kiểu ấn phẩm riêng.** Mã nguồn đặt mọi tiêu đề bằng chữ đơn cách và đánh số dòng code; Bài báo đưa các chuyên mục lên đầu báo và mở bài bằng chữ cái lớn; Sổ tay là giấy chấm lưới, liên kết tô bút dạ quang. Cài đặt vẽ bốn kiểu thành bốn thẻ có hình.
- **Sửa dọc đường:** bộ đệm trang lớn thêm sau mỗi lần deploy (502 MB trên một blog, một bài lưu 204 lần), danh sách thưa bị dồn lại khi lưu, danh sách trộn gạch đầu dòng và ô đánh dấu bị tách đôi, dấu đô la hay dấu ngã đã escape biến thành công thức hay gạch ngang, và dấu gạch chéo ngược lọt vào phần tóm tắt.

**2.2.13, ba ngày trước đó,** mở đường cho chữ đi ra: theo dõi được blog từ Mastodon, đọc được bằng chương trình qua `/api/v1`, tải về được dưới dạng Markdown mà công cụ khác mở được, và mỗi bài tự khai nó viết bằng tiếng gì.
