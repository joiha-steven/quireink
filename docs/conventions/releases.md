...
- **Versioning (do NOT auto-bump):** the version is **`2.2.10-beta.4`**, the fourth pre-release before 2.2.10, cut 2026-09-14 (2.2.9, released 2026-09-07, is still `latest`). From 2.0
