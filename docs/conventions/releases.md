...
- **Versioning (do NOT auto-bump):** the version is **`2.2.11`**, cut 2026-09-16, the repair release for 2.2.10 of the same day (which folded in five pre-releases; 2.2.9 was released 2026-09-07). From 2.0
