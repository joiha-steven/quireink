...
- **Versioning (do NOT auto-bump):** the version is **`2.2.10-beta.5`**, the fifth pre-release before 2.2.10, cut 2026-09-16 (2.2.9, released 2026-09-07, is still `latest`). From 2.0
