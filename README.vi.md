...
| `UPDATE_CHECK` | ◻️ | Đặt `0` để tắt cú gọi duy nhất mà phần mềm này tự thực hiện: mỗi ngày một lần, vào lượt khách đầu tiên, blog hỏi bản mới nhất là bản nào — và chính lúc hỏi thì được đếm là một blog đang được dùng. Thứ gửi đi là phiên bản đang chạy, một mã sinh lại theo ngày mới mỗi nửa đêm, và blog đã có tên miền thật hay chưa. Không có địa chỉ, bài viết, người đọc hay số liệu của bạn. Mặc định bật; [toàn bộ nội dung cú gọi viết ở đây](./docs/self-host.md#11-what-this-blog-tells-us-and-how-to-stop-it). Chủ blog có công tắc tương đương ở Settings → System |
