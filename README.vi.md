...
**2.2.9** là bản đang chạy, và là bản chạy trang demo ở trên lẫn blog của chính tác giả tại [manhhung.me](https://manhhung.me). [Nhật ký thay đổi](./CHANGELOG.md) ghi đủ.

Bản này gom hai đợt rà soát trong một ngày rưỡi. **Trang Cài đặt chia lại thành bảy tab theo câu hỏi bạn đang cầm trong đầu** chứ không theo chỗ nằm của mã, mỗi tab in câu hỏi của nó ngay dưới tên và có nút Lưu nói rõ đang còn mấy thay đổi chưa cất. Hai mươi hộp thoại của trình duyệt đã thay bằng hộp thoại của chính sản phẩm, gọi đúng tên thứ sắp bị xoá và không làm đơ trang phía sau. **Mọi độ xô lệch đo được lúc trang vừa hiện nay bằng 0**, trước đó là 0,136 ở trang chủ trên điện thoại và 0,059 trên máy tính, vì trang danh sách nay chỉ dựng ba mươi bài kèm một liên kết thay vì đổ cả kho rồi giấu đi. **Khung hình đầu của trang quản trị còn 375 KB, trước là 1.063 KB**, do trước đây nó tải cả mười một bộ từ điển và trình soạn thảo trước khi vẽ bất cứ thứ gì. Và một tá đường mất bài đã bịt: hai tab cùng lưu cài đặt thì xoá bài của nhau, đổi tên bài dở dang, trình soạn mở lại đúng bài vừa lưu khi bạn bấm viết bài mới, bản tin đang gửi thì chết theo request. Kèm luôn bản vá mà 2.2.8 cần: bản đó đăng nhập xong ra màn hình trắng.

**Và bản này KHÔNG làm được gì.** Chia lại tab nghĩa là ai quen tám tab cũ phải tìm lại một lần, ô tìm cạnh dãy tab và địa chỉ `?setting=<khoá>` là để lần đó không thành mãi mãi. Ba tab cuối vẫn có hai kiểu lưu cùng lúc: nút Lưu của trang cất các ô cài đặt thường, còn thẻ nào có kết nối ra ngoài như SMTP hay Cloudflare thì giữ nút riêng, vì cất một khoá và thử khoá đó là hai việc khác nhau. Màn Trợ giúp vẫn chỉ có tiếng Anh trong khi phần còn lại nói mười một thứ tiếng, và vài chỗ đếm số vẫn in "1 words" vì chưa có dạng số nhiều. Cột mục lục cạnh bài vẫn biến mất từ 1024px trở xuống, nút lưới trên điện thoại vẫn gần như không đổi gì, và trang nhất kiểu báo ở 820px vẫn có thể bỏ lại một thẻ đứng một mình. Không có gì trong bản này người đọc nhìn thấy như một tính năng mới: blog nào chủ không đăng nhập trong 2.2.8 thì được nhanh hơn và không mất gì. Các giới hạn cũ vẫn nguyên: NAS và Kubernetes không có Caddy, công tắc Chuyển động là của chủ chứ không phải của từng người đọc, bản cài dùng `sub_filter` của nginx để sửa HTML sẽ mất nén và mất validator của origin, vùng Cloudflare bật "JavaScript Detections" sẽ chèn một script không phải của phần mềm này, và origin không có CDN thì người đọc ở xa vẫn phải trả một vòng đi về mà tiết kiệm byte không mua lại được. Nâng cấp là `pull` rồi `up -d`; `docker compose up` không tự lấy bản mới.
